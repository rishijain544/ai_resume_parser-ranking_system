...
def load_spacy_model():
    try:
        # ऊपर दिए गए requirements.txt के बाद यह मॉडल लोड हो जाएगा
        return spacy.load("en_core_web_sm")
    except Exception as e:
        # केवल तभी एरर दिखाएगा जब इंस्टॉलेशन में समस्या हो
        st.warning("⚠️ Skills detection is currently limited. Please check dependencies.")
        return None
